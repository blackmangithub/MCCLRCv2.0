            ...
            <div class="card mt-4 border-0">
              <div class="card-body">
                  ...
                  <div class="col-xl-12">
                    ...
                    <div class="card mt-1">
                      <div class="card-body pt-3 d-md-flex d-sm-block">
                        <div class="col-xl-2">
                          <a href="book_details.php?title=<?= $book['title']; ?>" class="text-decoration-none">
                        ...
                        <div class="col-xl-10">
                          <div class="row mt-3">
                            <div class="col-lg-12 col-md-12 fs-6">
                              <a href="book_details.php?title=<?= $book['title']; ?>" style="text-decoration: none" class="fw-bold">
                ...
                <div class="col-12 col-md-3" data-aos="zoom-in">
                  <a href="book_details.php?title=<?= $book['title']; ?>">
