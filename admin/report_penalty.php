                                        ...
                                        <div class="col-12">
                                             <div class="data_table">
                                                  ...
                                                  if(isset($_POST['from_date']) && isset($_POST['to_date'])) {
                                                       ...
                                                       WHERE book_penalty > 0 AND date_returned BETWEEN '$from_date' AND '$to_date' 
                                                  ...
                                                  <table id="example" cellpadding="0" cellspacing="0" border="0"
                                                       ...
                                                       <div class="pull-left">
                                                            <div class="span">
                                                                 <div class="alert alert-info mt-2 p-1"><i
                                                                      ...
                                                                      Amount of Penalty:&nbsp;<?php echo "Php ".$count_penalty_row['sum(book_penalty)'].".00"; ?>
                                                                 </div>
                                                            </div>
                                                       </div>
                                                       ...
                                                       <tbody>
                                                            ...
                                                            ?>
                                                            <tr>
                                                                 <td class='<?php echo ($return_row['book_penalty'] != 'No Penalty') ? 'alert alert-warning' : ''; ?>' style='width:100px;'>Php <?php echo $return_row['book_penalty'].".00"; ?></td>
                                                                 <td style="text-transform: capitalize"><?php echo $return_row['firstname']." ".$return_row['lastname']; ?></td>
                                                                 <td><?php echo $admin; ?></td>
                                                                 <td><?php echo date("M d, Y h:i:s a", strtotime($return_row['due_date'])); ?></td>
