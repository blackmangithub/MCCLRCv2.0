                                        ...
                                        <form method="POST" action="">
                                             ...
                                             <tbody class="table-group-divider">
                                                  ...
                                                  if (isset($_POST['barcode'])) {
                                                       ...
                                                       if ($book_row['accession_number'] != $barcode) {
                                                            echo '
                                                            <tr>
                                                                 <td class="alert alert-info" colspan="8">No match for the barcode entered!</td>
                                                            </tr>';
                                                       } elseif ($barcode == '') {
                                                            echo '
                                                            <tr>
                                             ...
                                             if (isset($_POST['borrow'])) {
                                                  ...
                                                  if ($countBorrowed['books_allowed'] == $allowed['qntty_books']) {
                                                       ...
                                                       echo "<script>alert('Book Already Borrowed!'); window.location='circulation_faculty_borrowing.php?faculty_id=".$faculty_id."'</script>";
                                                  } else {
