...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2024 at 05:39 PM
...
(93, '1234', '1235', 'Computer Programming', 1, 'Rich', '2021', 'Mann', 'Kingdom', '12345678', 'MCC-LRC1235', '1719979739.jpg', '2024-07-03 12:08:59', 'Available'),
...
INSERT INTO `faculty` (`faculty_id`, `faculty_log_id`, `lastname`, `firstname`, `middlename`, `gender`, `course`, `address`, `cell_no`, `birthdate`, `email`, `username`, `password`, `cpassword`, `role_as`, `status`, `faculty_added`, `qr_code`, `verify_token`, `token_used`) VALUES
(12, 0, 'Calatero', 'Diovin', 'Pasicaran', 'Male', 'BSIT', 'Patao, Bantayan, Cebu', '09858024662', '2002-03-14', 'bman23382@gmail.com', 'diovin', '$2y$10$P0Vma8o3xlHDPX50z1GGpOOzhmLXS9A13tcBsvuhuiSIbrnUlu.b.', '', 'faculty', 'approved', '2024-07-05 07:05:22', 'diovin.png', '6242392cd30ed179fe13d7fa4f48306e', 0);
...
INSERT INTO `user` (`user_id`, `user_log_id`, `lastname`, `firstname`, `middlename`, `gender`, `course`, `address`, `cell_no`, `birthdate`, `email`, `year_level`, `student_id_no`, `password`, `cpassword`, `role_as`, `status`, `user_added`, `qr_code`, `verify_token`, `token_used`) VALUES
(84, 0, 'Calatero', 'Diovin', 'Pasicaran', 'Male', 'BSIT', 'Patao, Bantayan, Cebu', '09858024662', '2002-03-14', 'bman23382@gmail.com', '4th year', '2021-1055', '$2y$10$frgxFJiWLEjHNpKXmR86AejUIG/Q6oIYTFt8HFfMUhRhkU3KMbbgO', '', 'student', 'approved', '2024-07-01 20:04:19', '2021-1055.png', '6eafd98f85ec615bb2feb0420cb7a262', 0);
...
--
ALTER TABLE `borrow_book`
  MODIFY `borrow_book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=710;
...
--
ALTER TABLE `holds`
  MODIFY `hold_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
...
--
ALTER TABLE `report`
  MODIFY `report_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1527;

--
-- AUTO_INCREMENT for table `return_book`
--
ALTER TABLE `return_book`
  MODIFY `return_book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=735;
